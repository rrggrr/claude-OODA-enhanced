...
is their *orientation*, not their clock.

Signs you're inside their loop: they're reacting to your last move instead of
anticipating the next; they're explaining away surprises; their responses arrive
late and aimed at the wrong thing; internal disagreement and finger-pointing rise.

## The real mechanism: asymmetric fast transients

A "fast transient" is an abrupt, hard-to-follow change of state. The strategic
version (Chet Richards, *Certain to Win*): make moves that are **cheap for you and
expensive for them** to respond to. The asymmetry is the whole game.

- A price cut is a *bad* transient: trivially easy for a competitor to match, and
  it damages you too.
- A capability that took you years to build (faster onboarding, a distribution
  network, a trust relationship, a structural cost advantage) is a *good*
  transient: when you deploy it, they can't quickly copy it, so your move sticks
  and theirs can't.

Before any competitive move, ask: *how cheaply can they neutralize this?* Prefer
moves with a wide cost asymmetry in your favor.

## Speed is conditional, not the goal

Cycling faster only helps **if each cycle is at least as well-oriented as theirs.**
A fast loop on a wrong model just reaches the wrong answer sooner and burns
credibility doing it. Consequences:
...
Beware Goodhart's Law: the moment "cycle time" becomes the metric you optimize,
people will cycle faster on shallower thinking and the metric stops meaning
anything. Tempo is a means; mismatch is the end.
...
Boyd's deepest point about tempo is organizational. A team can only act fast
*without waiting for orders* if everyone shares enough orientation to act on
intent. The enablers (his German maneuver-warfare vocabulary):

- **Mission command (Auftragstaktik):** leaders set the *intent and the what*, not
  the *how*; people closest to the situation choose the how. This lets the edge of
  the organization run its own fast loops.
- **Mutual trust (Einheit):** the precondition. Without it, leaders micromanage and
  the loop slows to the speed of the slowest approval.
...
act in concert without a meeting.

## A short competitive checklist

- Whose orientation am I trying to make wrong, and how will I know it's working?
- Is my move a good transient (cheap for me, expensive for them) or a bad one
  (easy to match)?
- Am I cycling fast on a *good* orientation, or just fast?
- Where am I exposed to *their* transients, and have I pre-decided my responses?
- Does my team share enough context to act on intent without waiting for me?
