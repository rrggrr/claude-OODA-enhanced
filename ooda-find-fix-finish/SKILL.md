...
Before starting execution, **always ask the user:**

> "How many F3EAD cycles should I run? (default: 2)"

Wait for the answer (or use 2 if unspecified). Run exactly that many full
Find → Fix → Finish → EAD cycles.
...
EAD (feedback): what we learned (Exploit/Analyze) | who needs to know (Disseminate)
